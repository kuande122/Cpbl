...
def Baseballfield(option_teams):
   if option_teams == '中信兄弟':
      ...
      with col1:
       ...
       st.image(image)
      with col2:
        map = folium.Map(width='85%', height='80%',location=[24.19978, 120.68498], zoom_start=16)
        tooltip = "臺中洲際棒球場"
   ...
   if option_teams == '統一7-ELEVEn獅':   
      ...
      with col1:  
        ...
        st.image(image)
      with col2:  
        map = folium.Map(width='85%', height='100%',location=[22.98043, 120.2062], zoom_start=17)
        tooltip = "臺南市立棒球場"
   ...
   if option_teams == '樂天桃猿':     
      ...
      with col1: 
        ...
        st.image(image)
      with col2: 
        map = folium.Map(width='85%', height='100%',location=[25.00054,121.20038], zoom_start=16)
        tooltip = "桃園國際棒球場"
   ...
   if option_teams == '台鋼雄鷹':
      ...
      with col1:
        ...
        st.image(image)
      with col2:  
        map = folium.Map(width='85%', height='100%',location=[22.65449, 120.35892], zoom_start=17)
        tooltip = "高雄市澄清湖棒球場"
